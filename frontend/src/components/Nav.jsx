  ...
  return (
    <div className="w-[100vw] h-[80px] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-sm shadow-[#c69c6663] backdrop-blur-md bg-transparent">
      ...
      <div className="w-[30%] flex items-center justify-end gap-[20px]">
        ...
        />
        <p className="absolute w-[18px] h-[18px] items-center  justify-center bg-black px-[5px] py-[2px] text-white  rounded-full text-[9px] top-[17px] right-[26px] hidden md:block">
          {getCartCount()}
        </p>
        <div className=" fixed dark  left-[13%] top-[80px] h-[3px] w-[74%]"></div>
      </div>
      {showSearch && (
        <div className="w-[100%] backdrop-blur-sm h-[80px] absolute top-[100%] left-0 right-0 flex items-center justify-center ">
          <input
            type="text"
      ...
      >
        ...
        <p className="absolute w-[18px] h-[18px] flex items-center justify-center bg-white px-[5px] py-[2px] text-black font-semibold  rounded-full text-[9px] top-[15px] right-[14px]">
          {getCartCount()}
        </p>
      </div>
    </div>
