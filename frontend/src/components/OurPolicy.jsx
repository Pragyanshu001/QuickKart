...
function OurPolicy() {
  return (
    <div className="text w-[100vw] h-[100vh] md:h-[70vh] flex items-center justify-start flex-col  bg-gradient-to-l from-[#d4a465]  to-[#ab8758] gap-[50px] ">
      ...
      <div className="w-[100%] md:min-h-[50%] h-[20%] flex items-center justify-center flex-wrap lg:gap-[50px] gap-[80px]">
        <div className="w-[400px] max-w-[90%] h-[60%] flex items-center justify-center flex-col gap-[10px] ">
          ...
          <p className="font-semibold md:text-[25px] text-[19px] text-[#3b5dce]">
            Easy Exchange Policy
          </p>
          <p className="font-semibold md:text-[18px] text-[12px]  text-center">
