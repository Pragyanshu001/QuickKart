    ...
    <div className="text w-[100vw] min-h-[100vh] p-[20px] overflow-hidden bg-gradient-to-l  from-[#facf97]  to-[#dfc9ac]  ">
      ...
      <div className="flex justify-start items-end my-20">
        <div className="w-full sm:w-[450px]">
          <CartTotal />
          <button
            className="text-[18px]  hover:bg-slate-700 cursor-pointer bg-slate-500 py-[10px] px-[60px] rounded-2xl  flex items-center justify-center gap-[20px]  border-[1px] border-[#80808049] ml-[30px] mt-[20px]"
            onClick={() => {
