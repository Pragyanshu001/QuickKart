...
function About() {
  return (
    <div className=" w-[100vw] min-h-[100vh] flex items-center justify-center flex-col  bg-gradient-to-l from-[#d4a465]    to-[#ab8758] gap-[50px] pt-[80px]">
      ...
      <div className="w-[100%]  flex items-center justify-center flex-col lg:flex-row">
        ...
        <div className="text lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]">
          <p className="lg:w-[80%] w-[100%] md:text-[16px] text-[13px]">
          ...
          <p className="mast lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold">
            Our Mission
          </p>
          <p className="lg:w-[80%] w-[100%]  md:text-[16px] text-[13px]">
      ...
      <div className="w-[100%] flex items-center justify-center flex-col gap-[10px]">
        ...
        <div className="text w-[80%] flex items-center justify-center lg:flex-row flex-col py-[40px]">
          <div className="lg:w-[33%] w-[90%] h-[250px] border-[1px] border-gray-100 flex items-center justify-center gap-[20px] flex-col  px-[40px] py-[10px]  backdrop-blur-[2px] bg-[#ffffff0b]">
            <b className="mast text-[20px] font-semibold text-[#bff1f9]">
              Quality Assurance
            </b>
            <p>
